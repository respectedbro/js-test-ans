...
questionElements.forEach(question => {
    ...
    inputAnswers.forEach((input) => {
        const answerContainer = input.closest('.questions__elem');
        const correctAnswerElement = document.createElement('div');
        correctAnswerElement.className = 'correct-answer-text';
        ...
        input.addEventListener('keypress', (e) => {
            ...
            if (e.key === 'Enter' && !answerSelected) {
                ...
                if (userAnswer.toLowerCase() === corrAnswer.toLowerCase()) {
                    ...
                    correctAnswerElement.textContent = `Правильный ответ: ${corrAnswer}`;
